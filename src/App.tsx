  ...
  return (
    <Router>
      <div className="App">
        ...
        <Switch>
          <Route path="/blogPreviewFilter/:previewFilterName" children={<Previews />} />
          <Route path="/blogPost/:blogPostName" children={<BlogPost />} />
          <Route path="/impress" children={<Impress />} />
          <Route path="/aboutme" children={<AboutMe />} />
          <Route path="/" children={<Previews />} />
        </Switch>
